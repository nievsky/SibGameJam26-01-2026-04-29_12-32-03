...
- [ ] Add stronger hover feedback for selectable player pieces.
...
- [ ] Add clear hover feedback for valid destination cells.
...
- [ ] Add feedback for invalid clicks.
...
- [ ] Add a move preview before commit.
  - Goal: show where the selected piece will move.
  - Suggested implementation: destination pulse, path line, or ghost piece at the target cell.

- [ ] Improve capture feedback.
  - Goal: enemy captures should feel more satisfying and readable.
  - Suggested implementation: burst VFX, small camera impulse, capture sound variant, enemy shrink/dissolve.
...
- [ ] Add a small camera impulse on capture and transformation.
